...
if( isset( $_POST['submit'] ) ){
    ...
    if( $success ){
        echo '<div style="position: absolute; left: 25%; top: 45%; font-size: 50px;">File uploaded successfully.</div>';
    } else { 
        echo '<div style="position: absolute; left: 25%; top: 45%; font-size: 50px;">Something went wrong.</div>';
    }
}
